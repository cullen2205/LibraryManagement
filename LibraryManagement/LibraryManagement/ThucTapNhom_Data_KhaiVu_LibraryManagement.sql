...
insert into NganHang (MaNganHang, TenNganHang, DiaChi) values
('ACB', N'Ngân hàng Á Châu', N'Số 340 Phan Bội Châu Tp (tỉnh) Bạc Liêu'),
...
('BIDV', N'Đầu tư và Phát triển Việt Nam', N'Số 204 Bảo Khánh Tp (tỉnh) Khánh Hòa')
go


insert into NguoiDung (SoCMND, TenDangNhap, MatKhau, HoTen, SoDienThoai, DiaChiThuongTru, GioiTinh, NgaySinh, TenNguoiBaoHo, SDTNguoiBaoHo, DiaChiNguoiBaoHo) values
('0100100100', 'TK01', 'MK01', N'Nhâm Huyền Trâm', '034 9627 471', N'Số 239 Hà Trung Tp (tỉnh) Gia Lai', 0, '2001-06-05', N'Xa Công Tráng', '034 5151 905', N'Số 117 Đại Cồ Việt Tp (tỉnh) Sơn La'),
...
insert into NhanVien (MaNhanVien,MatKhau,TenNhanVien,SoCMND,DiaChi,SoDienThoai,GioiTinh,NgaySinh) values
('NV100101', 'MK01', N'Thẩm Hiệp Hòa', '037432728', N'Số 213 Nguyễn Chí Thanh Tp (tỉnh) Ninh Thuận', '034 9252 424', 0, '1990-01-28'),
...
-- nhân viên 1 là quản trị viên
update NhanVien set LaQuanTriVien = 0
go
update NhanVien set LaQUanTriVien = 1 where MaNhanVien = 'NV100101'
go

insert into Sach (MaSach, TenSach, TacGia, NamXuatBan, Gia, NhaXuatBan, GioiHanTuoi) values
('S001', N'Tôi tài giỏi, bạn cũng thế', N'Adam Khoo', 1950, 40000, N'NXB Công An', 15),
('S002', N'Đắc nhân tâm', N'Dale Carnegie', 1951, 21000, N'NXB Công An Nhân Dân', 18),
('S003', N'Tội ác và trừng phạt', N'Dostoevsky.', 1952, 24000, N'NXB Công An', 18),
('S004', N'Nhà giả kim', N'Paulo Coelho', 1953, 23000, N'NXB Công An', 18),
('S005', N'Bắt trẻ đồng xanh', N'J.D.Salinger', 1954, 24000, N'NXB Đại Học Kinh Tế Quốc Dân', 11),
('S006', N'Xách ba lô lên và đi', N'Chưa rõ', 1955, 25000, N'NXB Khoa Học Xã Hội', 12),
('S007', N'Cứ đi rồi sẽ đến', N'Minh DeltaViet', 1956, 26000, N'NXB Hồng Đức', 15),
('S008', N'7 thói quen để thành đạt', N'Stephen R', 1957, 27000, N'NXB Khoa Học Xã Hội', 12),
('S009', N'Bố Già', N'Mario Puzo', 1958, 28000, N'NXB Hồng Đức', 18),
('S010', N'Zen and the Art of Motorcycle Maintenance', N'Robert M. Pirsig', 1959, 29000, N'NXB Hồng Đức', 15),
('S011', N'Watership Down', N'Richard Adams', 1950, 40000, N'NXB Phương Đông', 12),
('S012', N'The Last Lecture', N'Randy Pausch & Jeffrey Zaslow', 1951, 21000, N'NXB Phương Đông', 12),
('S013', N'A Short History of Nearly Everything', N'Bill Bryson', 1952, 24000, N'NXB Phương Đông', 13),
('S014', N'Man is Search for Meaning', N'Viktor Frankl', 1953, 23000, N'NXB Thông Tin Và Truyền Thông', 13),
('S015', N'The Forever War', N'Joe Haldeman', 1954, 24000, N'NXB Thông Tin Và Truyền Thông', 13),
('S016', N'Cosmos', N'Carl Sagan', 1955, 25000, N'NXB Thông Tin Và Truyền Thông', 16),
('S017', N'Bartleby The Scrivener: A Story of Wall-Street', N'Herman Melville', 1956, 26000, N'NXB Trẻ', 16),
('S018', N'Maus: A Survivor''s Tale', N'Art Spiegelman', 1957, 27000, N'NXB Trẻ', 16),
('S019', N'For Whom the Bell Tolls', N'Ernest Hemingway', 1958, 28000, N'NXB Từ Điển Bách Khoa', 18),
('S020', N'Kafka on the Shore', N'Haruki Murakami', 1959, 29000, N'NXB Từ Điển Bách Khoa', 18),
('S021', N'The Little Prince', N'Antoine de Saint-Exupéry', 1950, 40000, N'NXB Văn Hóa Văn Nghệ TPHCM', 18),
('S022', N'The Road', N'Cormac McCarthy', 1951, 21000, N'NXB Văn Hóa Văn Nghệ TPHCM', 18),
('S023', N'One Hundred Years of Solitude', N'Gabriel Garcia Marquez', 1952, 24000, N'NXB Văn Nghệ TP.HCM', 03),
('S024', N'East of Eden', N'John Steinbeck', 1953, 23000, N'NXB Văn Nghệ TP.HCM', 05),
('S025', N'How to Win Friends and Influence People', N'Dale Carnegie', 1954, 24000, N'NXB Văn Nghệ', 05),
('S026', N'Crime and Punishment', N'Fyodor Dostoyevsky', 1955, 25000, N'NXB Văn Nghệ', 06)
go
...
('TL01', N'Chính trị'),
('TL02', N'Pháp luật'),
('TL03', N'Khoa học công nghệ'),
('TL04', N'Kinh tế'),
('TL05', N'Văn hóa xã hội'),
('TL06', N'Lịch sử'),
('TL07', N'Văn học nghệ thuật'),
('TL08', N'Giáo trình'),
('TL09', N'Truyện, tiểu thuyết'),
('TL10', N'Tâm lý'),
('TL11', N'Tâm linh'),
('TL12', N'Tôn giáo'),
('TL13', N'Sách thiếu nhi'),
('TL14', N'Alternate history'),
('TL15', N'Autobiography'),
('TL16', N'Anthology'),
('TL17', N'Biography'),
('TL18', N'Chick lit'),
('TL19', N'Book review'),
('TL20', N'Children''s literature'),
('TL21', N'Cookbook'),
('TL22', N'Comic book'),
('TL23', N'Comic book'),
('TL24', N'Diary'),
...
insert into dbo.NguoiDung_NganHang (SoCMND, MaNganHang, SoTaiKhoanNganHang) values
...
insert into dbo.Sach_TheLoai (MaSach, MaTheLoai) values
('S001', 'TL04'),
('S001', 'TL01'),
('S002', 'TL02'),
('S002', 'TL03'),
...
--insert into MuonSach (SoCMND, MaSach, MaNhanVien, NgayMuon) values
--('0100100114', 'S001', 'NV100120', '1973-12-17'),
...
--('0100100100', 'S023', 'NV100114', '2002-06-26')
--go

---- // update ngày phải trả
update MuonSach set NgayTra = DATEADD(day,150,NgayMuon)
go
---- // update tình trạng sách là chưa trả
update MuonSach set TinhTrang = 0
go

--insert into dbo.NhanSach (MaSach, MaNhanVien, NgayNhanSach) values
--('S001', 'NV100101', '1974-04-09'),
--('S002', 'NV100115', '2009-05-07'),
---- ('S003', 'NV100123', '1997-09-16'),
--('S004', 'NV100106', '2010-04-12'),
---- ('S005', 'NV100118', '2010-07-09'),
--('S006', 'NV100134', '1977-04-26'),
--('S007', 'NV100102', '2000-12-12'),
--('S008', 'NV100103', '1993-12-22'),
---- ('S009', 'NV100127', '2008-09-05'),
--('S010', 'NV100136', '1977-08-15'),
--('S011', 'NV100103', '1988-12-30'),
--('S012', 'NV100140', '1978-04-23'),
--('S013', 'NV100102', '1972-11-14'),
---- ('S014', 'NV100111', '2013-09-27'),
--('S015', 'NV100135', '1991-03-21')
--go

---- // update số ngày trễ hạn
update NhanSach set NgayTreHan = DATEDIFF(day,(select ms.NgayTra from MuonSach ms where ms.MaSach = NhanSach.MaSach and ms.TinhTrang = 0),NgayNhanSach)
go
---- // update tình trạng sách là đã trả trong table mượn sách
update MuonSach set TinhTrang = 1 from NhanSach ns where MuonSach.MaSach = ns.MaSach and TinhTrang = 0 
	and DATEDIFF(day,
			(select MAX(ns2.NgayNhanSach) from NhanSach ns2 where ns2.MaSach = MuonSach.MaSach),
			(select MAX(NgayMuon) from MuonSach, NhanSach ns3 where ns3.MaSach = MuonSach.MaSach)) > 0
go